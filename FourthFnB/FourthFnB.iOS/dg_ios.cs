...
namespace Zumero.DataGrid.iOS.Core
{
    public class DataPanelView<TGraphics> : UIView, INativeView
    {
        ...
        {
            this.Frame = new CGRect((float)x, (float)y, (float)width, (float)height);
        }
        ...
        {
            var wh = (CGPoint)gr.LocationInView((UIView)this);
        ...
        public override void Draw(CGRect unused)
        {
    ...
    public class ScrollableDataPanelView<TGraphics> : DataPanelView<TGraphics>
    {
        ...
        public ScrollableDataPanelView(IScrollablePanel<TGraphics> dp, Func<DataPanelView<TGraphics>, TGraphics> func_gr)
            : base(dp, func_gr)
        {
        ...
        private class pan_gr : UIPanGestureRecognizer
        {
            ...
            public pan_gr(ScrollableDataPanelView<TGraphics> dg)
                : base(on_fire)
            {
                _dg = dg;
            }
            ...
            private static void on_fire(UIPanGestureRecognizer gr)
            {
                ...
                {
                    var pt = (CGPoint)gr.TranslationInView((UIView)me._dg);
