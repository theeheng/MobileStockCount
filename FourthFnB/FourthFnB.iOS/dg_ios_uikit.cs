...
namespace Zumero.DataGrid.iOS.UIKit
{
    public class DataGridBase : IDataGrid<CGContext>
    {
        ...
        {
            public MainPanel(IDimension cbcol, IDimension cbrow, IDrawVisible<CGContext> cbdraw)
                : base(cbcol, cbrow, cbdraw)
            {
            }
        }
        ...
        {
            public FrozenColumnsPanel(IDimension cbcol, IDimension cbrow, IDrawVisible<CGContext> cbdraw)
                : base(cbcol, cbrow, cbdraw)
            {
            }
        }
        ...
        {
            public FrozenRowsPanel(IDimension cbcol, IDimension cbrow, IDrawVisible<CGContext> cbdraw)
                : base(cbcol, cbrow, cbdraw)
            {
            }
        }
        ...
        {
            public DrawCell_Chain_Padding(IValuePerCell<Padding?> vals, IDrawCell<CGContext> cd)
                : base(vals, cd)
            {
            }
        }
        ...
        protected class DrawCell_Oval : DrawCell<CGContext, CGColor>
        {
            ...
            {
                gr.SetFillColor(clr);
                gr.FillEllipseInRect(new CGRect((float)x, (float)y, (float)width, (float)height));
            }

            public DrawCell_Oval(CGColor clr)
                : base(new ValuePerCell_Steady<CGColor>(clr), draw)
            {
            }
        }
        ...
        protected class DrawCell_Fill : DrawCell<CGContext, CGColor>
        {
            ...
            {
                gr.SetFillColor(clr);
                gr.FillRect(new CGRect((float)x, (float)y, (float)width, (float)height));
            }

            public DrawCell_Fill(IValuePerCell<CGColor> vals, IDrawCell<CGContext> chain = null)
                : base(vals, draw, chain)
            {
            }
        }
    ...
    {
        public DataGridView(DataGridBase grid)
            : base(grid)
        {
